...
import { UpdatePayment } from "../../../../services/remote/put/UpdatePayment";
function UpdatePaymentModal({ UpdatePaymentShowModal, setUpdatePaymentShowModal, fetchDataPayment, paymentToUpdate }) {
    ...
    const formik = useFormik({
        initialValues: {
            idpago: paymentToUpdate?.idpago || '',
            IdInstitutoOK: paymentToUpdate?.IdInstitutoOK || '',
            IdNegocioOK: paymentToUpdate?.IdNegocioOK || '',
            IdPagoOK: paymentToUpdate?.IdPagoOK || '',
            IdPagoBK: paymentToUpdate?.IdPagoBK || '',
            IdOrdenOK: paymentToUpdate?.IdOrdenOK || '',
            MontoTotal: paymentToUpdate?.MontoTotal || '',
            Observacion: paymentToUpdate?.Observacion || '',
        },
        ...
        onSubmit: async (values) => {
            ...
            setTimeout(() => {
                setUpdatePaymentShowModal(false);
            }, 2500);
            setUpdatePaymentShowModal(false);
        },
    });
            ...
            <form onSubmit={formik.handleSubmit}>
                ...
                <DialogActions sx={{ display: 'flex', flexDirection: 'row' }}>
                    ...
                    <LoadingButton
                        ...
                        startIcon={<CloseIcon />}
                        variant="outlined"
                        onClick={() => setUpdatePaymentShowModal(false)}
                    >
                        <span>CERRAR</span>
                    </LoadingButton>
                    <LoadingButton
